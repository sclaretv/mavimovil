		...
		<div class="row">
			<div class="col-lg-6">
				<div class="text-center">
					<img alt="Mavimovil" src="assets/web/img/logotipo-mavimovil.svg" width="400" height="150">
				</div>
				<div>
			...
			<div class="col-lg-6">
				...
				<div class="text-center">
					<p class="paragraph-3"><strong>Los mercados en los cuales hemos creado son:</strong></p>
				</div>
				...
				<div class="row container-2-a text-center">
					<div class="col-md-3">
						...
						<span class="text-fondo-blanco">Estilo de Vida</span>
					</div>
					<div class="col-md-3">
				...
				<div class="row text-center">
					<div class="col-md-3">
						...
						<span class="text-fondo-blanco text-center">Industrial</span>
					</div>
					<div class="col-md-3">
