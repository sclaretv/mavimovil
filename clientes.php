<div class="container">
			...
			<div class="carousel-confian">
			    <div><img class="imagen-confian" alt="KAUFMANN" src="assets/web/img/clientes_01.png"  height="50"></div>
			...
			<!-- version responsive-->
			<div class="carousel-confian2">
				<div class="row">
					<div class="col-sm-4 col-sm-offset-4 ">

					    <div><img class="imagen-confian2" alt="KAUFMANN" src="assets/web/img/clientes_01.png"  height="50"></div>
					    <div><img class="imagen-confian2" alt="AUTOFIN" src="assets/web/img/clientes-02.png"  height="50"></div>
					    <div><img class="imagen-confian2" alt="MAVIGPS" src="assets/web/img/clientes-03.png"  height="50"></div>
					    <div><img class="imagen-confian2" alt="MALLPLAZA" src="assets/web/img/clientes-04.png"  height="50"></div>
					    <div><img class="imagen-confian2" alt="BKSPA" src="assets/web/img/clientes-05.png"  height="50"></div>
					    <div><img class="imagen-confian2" alt="REDSALUD" src="assets/web/img/clientes-06.png"  height="50"></div>
